       ...
       try {
        ...
        if ($this->request()->isAjax()) {
            $info = array(
                ...
                'win'          => number_format((LotteriesModel::instance()->getMoneyTotalWin() + self::MONEY_ADD)  * $gameSettings->getCountryCoefficient($this->country), is_int(LotteriesModel::instance()->getMoneyTotalWin()) ? 0 : 2, '.', ' ') . ' <span>' . Config::instance()->langCurrencies[$this->country] . '</span>',
            );
