...
class Hybrid_Providers_Odnoklassniki extends Hybrid_Provider_Model_OAuth2
{
    ...
    function getUserProfile()
    {
        ...
        $sig = md5('application_key=' .
            $this->config['keys']['key'] .
            'method=users.getCurrentUser' .
            md5($this->api->access_token .
        ...
        if ( isset( $response->error_code) ){
            throw new Exception( "User profile request failed! {$this->providerId} returned error: ".$response->error_code." ".$response->error_msg, 6 );
        }
