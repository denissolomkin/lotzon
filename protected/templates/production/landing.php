                    ...
                    <div class="m-tr_td">
                        <div class="h-t-mcb">
                            ...
                            <div class="h-t-mcb-r">
                                ...
                                <div class="h-t-mcb-r-i" id="win"><?=number_format($gameInfo['win'], is_int($gameInfo['win']) ? 0 : 2, '.', ' ')?> <span><?=$currency?></span></div>
                            </div>
                        </div>
                        <div class="h-t-bcb">
                            ...
                            <div class="a-tbl">
                                ...
                                <ul class="r_ul">
                                    <? for ($i = 6; $i >= 1; --$i) { ?>
                                        ...
                                        <div class="ri-e"><?=number_format($gameInfo['lotteryWins'][$i]['sum'], is_int($gameInfo['lotteryWins'][$i]['sum']) ? 0 : 2, '.', ' ')?> <?=($gameInfo['lotteryWins'][$i]['currency'] == GameSettings::CURRENCY_POINT ? 'баллов' : $currency)?></div>
                                    </li>
                                    <? } ?>
                                </ul>
                            </div>
