                ...
                <div class="pz-fm-bk">
                    ...
                    <div class="fm-inps-bk">
                        ...
                        <div class="pi-inp-bk td">
                            ...
                            <input autocomplete="off" spellcheck="false" type="text" name="nick" placeholder="Город / Село / Поселок">
                        </div>
                        <div class="pi-inp-bk td">
                            <div class="ph">Адрес</div>
                            <input autocomplete="off" spellcheck="false" type="text" name="nick" placeholder="Адрес" maxlength="40">
                        </div>
                        <div class="pi-inp-bk td">
                            <div class="ph">Телефон</div>
                            <input autocomplete="off" spellcheck="false" type="tel" name="nick" value="<?=$player->getPhone();?>" data-type="phone" placeholder="Телефон" maxlength="40">
                        </div>
                    </div>
