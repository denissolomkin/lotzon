...
<html class="no-js" xmlns="http://www.w3.org/1999/html"> <!--<![endif]-->
    ...
    <style>#<?php echo $antiblock_layer_id; ?>{z-index: 10000;position:fixed !important;position:absolute;top:<?php echo mt_rand(-3, 3); ?>px;top:expression((t=document.documentElement.scrollTop?document.documentElement.scrollTop:document.body.scrollTop)+"px");left:<?php echo mt_rand(-3, 3); ?>px;width:<?php echo mt_rand(98, 103); ?>%;height:<?php echo mt_rand(98, 103); ?>%;background: rgba(0,0,0,0.85);display:block;padding:5% 0}#<?php echo $antiblock_layer_id; ?> *{text-align:center;margin:0 auto;display:block;filter:none;font:15px/50px Handbook-bold;text-decoration:none}#<?php echo $antiblock_layer_id; ?> ~ *{/*display:none*/}#<?php echo $antiblock_layer_id; ?> div{margin-top: -100px;} #<?php echo $antiblock_layer_id; ?> div a[href]{display: inline-block;text-transform: uppercase;width:220px;height:50px; }#<?php echo $antiblock_layer_id; ?> div a.please {background-color:#ffe400;color:#000;cursor:pointer;}#<?php echo $antiblock_layer_id; ?> div a.please:hover {background-color:#000!important;color:#fff;}#<?php echo $antiblock_layer_id; ?> img{background-color: white;height: 500px;width: 540px;}</style>
