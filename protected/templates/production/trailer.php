...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <main>
        <article>
            ...
            <div class="txt-box">
                <div class="text">Здравствуйте! Мы бесплатная онлайн лотерея. Получайте призы, выигрывайте деньги и конечно же срывайте JackPot.<br/><br/>Пожалуйста, оставьте свой email, чтобы одним из первых узнать о нашем открытии. Первую тысячу счастливчиков ждет приятный сюрприз. Удачи!</div>
            </div>
            <div class="form">
