<div class="content-top">
	<div class="content-main">
		...
		<div class="content-box">
			...
			<div class="content-box-content cashout-block clearfix">

				<div class="cabinet-cashout-block">
					В вашем аккаунте замечена подозрительная активность, детали можно посмотреть в <a href="communication_messages">сообщениях</a>
				</div>
				...
				<div class="content-box-item cabinet-cashout">
					...
					<div class="cco-choose-method">
						<form action="cabinet_cashout_blocked">
