                ...
                <div id="hr-io-slider">
                    <div class="pw-gm-rt">
                        <div class="ct">
                            ...
                            <b class="n"><?=number_format($gameInfo['lotteryWins'][6]['sum'], 2, '.', ' ')?> <span><?=$currency?></span></b>
                        </div>
                    </div>
                    <div class="pw-gm-rt">
                        <div class="ct">
                    ...
                    <div class="pw-gm-rt">
                        <div class="ct">
                            ...
                            <b class="n"><?=number_format($gameInfo['win'], 2, '.', ' ')?> <span><?=$currency?></span></b>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="w-ct">
                    ...
                    <section class="prizes">
                        <div class="sbk-tl-bk">
                            ...
                            <div class="pbk-pi">на счету <b class="plPointHolder"><?=number_format($player->getPoints(), 2, '.', ' ')?></b> баллов</div>
                        </div>
                        <div class="pbk-ct">
                                ...
                                <ul class="c-r">
                                    <? for ($i = 6; $i >= 1; --$i) { ?>
                                        <li class="c-r_li">
                                            ...
                                            <div class="tb-t"><?=number_format($gameInfo['lotteryWins'][$i]['sum'], 2, '.', ' ')?> <?=($gameInfo['lotteryWins'][$i]['currency'] == GameSettings::CURRENCY_POINT ? 'баллов' : $currency)?></div>
                                        </li>
                                    <? } ?>
                                </ul>
                                <div class="b-cl-block"></div>
                    ...
                    <div class="p-cnt">
                        <aside>
                            ...
                            <div class="p-stat-bk">
                                ...
                                <div class="cr-st-bk">
                                    <div class="ifo"><b><?=number_format($player->getMoney(), 2, '.', ' ')?></b><?=$country == 'UA' ? 'гривен' : 'рублей'?> на счету</div>
