var Games = {
    ...
    wheel: {
        init: function (data) {
            ...
            if(Games.wheelEntity) {
                Games.wheelEntity.gotoMenu();
            } else {
                Games.wheelEntity = new CMain({
                    ...
                    wheel_settings: [
                        {prize: 10, win_occurence: 7}, {prize: 30, win_occurence: 6}, {
                            prize        : 60,
                            win_occurence: 6
                        }, {prize: 90, win_occurence: 6}, {prize: 0, win_occurence: 5},
                        {prize: 20, win_occurence: 6}, {prize: 60, win_occurence: 5}, {
                            prize        : 120,
                            win_occurence: 4
                        }, {prize: 200, win_occurence: 3}, {prize: 0, win_occurence: 5},
                        {prize: 40, win_occurence: 5}, {prize: 30, win_occurence: 5}, {
                            prize        : 20,
                            win_occurence: 6
                        }, {prize: 10, win_occurence: 7}, {prize: 0, win_occurence: 5},
                        {prize: 80, win_occurence: 4}, {prize: 60, win_occurence: 4}, {
                            prize        : 40,
                            win_occurence: 5
                        }, {prize: 1000, win_occurence: 1}, {prize: 0, win_occurence: 5}
                    ],
                ...
                $(Games.wheelEntity).on("start_session", function (evt) {
                ...
                $(Games.wheelEntity).on("end_session", function (evt) {
                    if (getParamValue('ctl-arcade') === "true") {
                ...
                $(Games.wheelEntity).on("save_score", function (evt, iScore) {
                    if (getParamValue('ctl-arcade') === "true") {
                ...
                $(Games.wheelEntity).on("show_interlevel_ad", function (evt) {
                    if (getParamValue('ctl-arcade') === "true") {
                ...
                $(Games.wheelEntity).on("share_event", function (evt, iScore, szImage, szTitle, szMsg, szMsgShare) {
                    if (getParamValue('ctl-arcade') === "true") {
