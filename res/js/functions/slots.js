...
stripHeight: 720,
        ...
        slotMachine.change_bet(0), Player.updateBalance(); // resset static data
        ...
        if (!$("#slotsSelectorWrapper").hasClass('gold')) {
        $("#slotsSelectorWrapper").addClass('gold'), $(this).addClass('active'), $("#Scores").removeClass('active'), $('#credits').attr('class', 'holder-money');
                // change credits code..
                Player.updateBalance(), slotMachine.useMoney = !0;
        }
        }), $("#Scores").click(function () {
        if ($("#slotsSelectorWrapper").hasClass('gold')) {
        $("#slotsSelectorWrapper").removeClass('gold'), $(this).addClass('active'), $("#Gold").removeClass('active'), $('#credits').attr('class', 'holder-points');
                // change credits code..
                Player.updateBalance(), slotMachine.useMoney = !1;
        }
        ...
        var n = $(this);
                n.html((n.attr("data-payoutPrefix") || "") + parseInt(n.attr("data-basePayout"), 10) * (slotMachine.curBet * slotMachine.xFactor) + (n.attr("data-payoutSuffix") || ""))
        })
        },
        ...
        var n = parseFloat($("#credits").html().replace(',', '.').replace(' ', ''), 10);
                ...
                $("#credits").html(Player.fineNumbers(n - slotMachine.curBet * slotMachine.xFactor)),
