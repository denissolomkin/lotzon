...
if ($_SERVER['REQUEST_URI'] != '/trailer' && $_SERVER['REQUEST_URI'] != '/trailer/') {
    if (!in_array($_SERVER['REMOTE_ADDR'], array('81.20.200.182','79.139.133.100','82.146.41.129','94.228.204.10', '193.232.184.141','46.174.161.159','77.91.183.217', '93.72.151.96', '193.239.152.37', '188.231.153.219', '212.90.61.122', '212.42.94.154', '212.90.61.55', '195.211.145.115', '176.36.137.116'))) {
